"""Regression checks for the raster-rel-retry-grid casebook."""
...
from casebook.harness import assert_expected, raster_rel_retry_grid_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(raster_rel_retry_grid_summary(), assert_expected())
